  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const appointmentsResponse = await axios.get('http://localhost:5000/api/get-upcoming-appointments', {
          headers: {
        ...
        const consultationsResponse = await axios.get('http://localhost:5000/api/get-upcoming-consultations', {
          headers: {
            Authorization: `Bearer ${token}`, // Attach the token to the request
          },
        });
